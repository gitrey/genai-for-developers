            ...
            steps {
                dir("${env.WORKSPACE}/outer-loop-cli") {
                    ...
                    withCredentials([
                            ...
                            ./venv/bin/devai review testcoverage -c /bitnami/jenkins/home/workspace/genai-cicd_genai-for-developers/sample-app/src/main/java/anthos/samples/bankofanthos/balancereader
                            '''
                            }
                }
            }
